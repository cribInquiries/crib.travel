...
const DiningRoomAmenities = ({
  ...
  const propertyTypes = [
    ...
    { value: "chairs", label: "Chairs", icon: Sofa },
    { value: "highchair", label: "Highchair", icon: Sofa },
    { value: "barStools", label: "Bar Stools", icon: Sofa },
    { value: "buffetSideboard", label: "Buffet/Sideboard", icon: ChefHat },
    { value: "wineRack", label: "Wine Rack", icon: ChefHat },
  ];
  ...
  return (
    ...
    <Box mt={4}>
      {/* Selected Dining Room Amenities */}
...
export default DiningRoomAmenities;
