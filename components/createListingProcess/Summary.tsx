  ...
  return (
    ...
    >
      ...
      <Flex direction={{ base: "column", md: "row" }} gap={8}>
                ...
                >
                  ...
                  <Box gap={0} w={"100%"} mt={4}>
                    <Text fontSize={"16px"}>
                      ...
                      the beauty of Malibu with guests from around the world. As
                      a local, I can provide insider tips on the best beaches,
        ...
        <Card.Root p={6} position="sticky" top={4} flex={1}>
          <Card.Header fontSize="2xl" fontWeight="semibold" mb={4}>
            ${basePrice}
          </Card.Header>
          <Button width="full" mb={4} onClick={() => console.log(imageDetails)}>
            Reserve Now
          </Button>
